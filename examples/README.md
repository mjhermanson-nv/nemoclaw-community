...
| [Ask NemoClaw](recipes/nvidia/browser-context-knowledge-assistant/README.md) | ✨ Other | Adds an authenticated Chrome side panel that sends an arbitrary user prompt, readable page text, and the rendered visible viewport to a NemoClaw agent running with Hermes. |
